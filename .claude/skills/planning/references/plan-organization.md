...
- Contains path to current working plan (e.g., `agent-includes/plans/20251128-1654-feature-name`)
...
4. Fallback: `agent-includes/plans/reports/` if no active-plan exists
