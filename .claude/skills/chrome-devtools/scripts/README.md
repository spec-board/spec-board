...
**Automatic Compression**: Screenshots >5MB are automatically compressed using ImageMagick to ensure compatibility with AI APIs (Nebius, Claude). Install ImageMagick for this feature:
