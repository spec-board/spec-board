...
2. **Deep Content Analysis**:
   - When you found a potential Github repository URL, use `librarian` skill to find read it.
...
**Notes:** 
- Research reports are saved in `./agent-includes/plans/<plan-name>/reports/YYMMDD-<your-research-topic>.md`.
...
1. Be saved as a markdown file with a descriptive filename in `./agent-includes/plans/<plan-name>/reports/YYMMDD-<your-research-topic>.md`
