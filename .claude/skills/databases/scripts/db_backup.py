...
def main():
    ...
    backup_parser.add_argument("--uri",
                               default=os.environ.get("DATABASE_URI"),
                               help="Database connection string (or set DATABASE_URI env var)")
    ...
    restore_parser.add_argument("--uri",
                               default=os.environ.get("DATABASE_URI"),
                               help="Database connection string (or set DATABASE_URI env var)")
    ...
    if args.command == "backup":
        if not args.uri:
            print("Error: Database URI is required.", file=sys.stderr)
            print("Provide --uri argument or set DATABASE_URI environment variable.", file=sys.stderr)
            sys.exit(1)
