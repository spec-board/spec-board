  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="border-b border-[var(--border)] bg-[var(--card)]">
        <div className="max-w-6xl mx-auto" style={{ padding: 'var(--space-2) var(--space-3)' }}>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 h-full" style={{ gap: 'var(--space-4)' }}>
          {/* Left side - Recent Projects */}
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between" style={{ marginBottom: 'var(--space-2)' }}>
              <h2 className="font-semibold" style={{ fontSize: 'var(--text-lg)' }}>Recent Projects</h2>
          ...
          <div className="lg:col-span-1">
            <h2 className="font-semibold" style={{ fontSize: 'var(--text-lg)', marginBottom: 'var(--space-2)' }}>Actions</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-1-5)' }}>
              <button
                onClick={() => setIsModalOpen(true)}
                className="w-full flex items-center justify-center gap-2 border border-[var(--border)] hover:bg-[var(--card-hover)] text-[var(--foreground)] focus-ring"
                style={{
              ...
              <p className="text-[var(--muted-foreground)] text-center" style={{ fontSize: 'var(--text-xs)' }}>
